...
class LeaveBrotherBrace: Task {
    override val displayName = "Leaving Brother Brace"
    override val priority = 0

    override fun canRun(): Boolean {
        return GameState.getSetting(281) == 610
    }
    ...
    override fun execute() {
        ...
        if (door.interact("Open")) {
            Waiting.waitUntil(TutPreferences.longDelayMs()) {
                !Query.npcs().nameEquals("Brother Brace").isReachable.isAny
            }
        }
    }
}